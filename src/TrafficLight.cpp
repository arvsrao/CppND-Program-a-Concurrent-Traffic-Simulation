...
TrafficLight::TrafficLight() : _currentPhase(TrafficLightPhase::red), _randomNumberBetween4AndSix(RandomNumberBetween(4,6)) {}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    int waitTime = _randomNumberBetween4AndSix();
    ...
    while(true) {
        ...
        if (timeDelta.count() > waitTime) {
            toggleTrafficLight();
            _message.send(this->getCurrentPhase());
            waitTime = _randomNumberBetween4AndSix();
